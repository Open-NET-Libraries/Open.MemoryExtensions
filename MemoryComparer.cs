...
namespace Open.Memory
{
	...
	public static class MemoryComparer
	{
		...
		{
			public static readonly IComparer<ReadOnlyMemory<float>> Ascending = new MemoryFloatComparer(+1);
		...
		{
			public static readonly IComparer<ReadOnlyMemory<double>> Ascending = new MemoryDoubleComparer(+1);
